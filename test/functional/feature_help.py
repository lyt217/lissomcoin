...
"""Verify that starting lissomcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start lissomcoin with -h for help text")
        ...
        self.log.info("Start lissomcoin with -version for version information")
        ...
        self.log.info("Start lissomcoind with -fakearg to make sure it does not start")
