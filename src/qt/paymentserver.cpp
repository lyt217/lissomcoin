...
const char* BIP71_MIMETYPE_PAYMENT = "application/lissomcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/lissomcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/lissomcoin-paymentrequest";
#endif
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start lissomcoin: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("lissomcoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'lissomcoin://' is not a valid URI. Use 'lissomcoin:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Lissomcoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
