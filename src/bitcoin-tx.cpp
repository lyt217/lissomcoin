...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " lissomcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  lissomcoin-tx [options] <hex-tx> [commands]  Update hex-encoded lissomcoin transaction\n" +
            "or:     lissomcoin-tx [options] -create [commands]   Create hex-encoded lissomcoin transaction\n" +
            "\n";
