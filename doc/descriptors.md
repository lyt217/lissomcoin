# Support for Output Descriptors in Lissomcoin Core

Since Lissomcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Lissomcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Lissomcoin Core wallets, a convenience function `combo` is
